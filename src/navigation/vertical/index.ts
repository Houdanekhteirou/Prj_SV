...
const navigation = (): VerticalNavItemsType => {
  return [
    ...
    {
      title: 'Data',
      // requiredPermissions: [PERMISSIONS.fileType.read, PERMISSIONS.element.read, PERMISSIONS.validation.read],
      children: [
        {
          title: 'Validation',
    ...
    //   path: '/admin/data/planification',
    //   requiredPermissions: [PERMISSIONS.planification.read]
    // },
    {
      title: 'Organizations',
    ...
    {
      sectionTitle: 'Autres',
      // requiredPermissions: [PERMISSIONS.report.generate, PERMISSIONS.completeness.read]
    },
