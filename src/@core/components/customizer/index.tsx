...
const Customizer = () => {
  ...
  return (
    <div className='customizer'>
      <Toggler className='customizer-toggler flex flex-col gap-4'>
        <Icon icon='ion:arrow-back' fontSize={20} onClick={() => router.back()} />
        <Divider />
        <Icon icon='mdi:cog-outline' fontSize={20} onClick={() => setOpen(true)} />
      </Toggler>
      <Drawer open={open} hideBackdrop anchor='right' variant='persistent'>
        ...
        >
          ...
          <Typography sx={{ color: 'text.secondary' }}>{t('Customize & Preview in Real Time')}</Typography>
          <IconButton
        ...
        <PerfectScrollbar options={{ wheelPropagation: false }}>
          <CustomizerSpacing className='customizer-body'>
            ...
            {/* Color Picker */}
            <div>
              <Typography sx={{ mb: 2.5 }}>{t('Primary Color')}</Typography>
              <Box sx={{ display: 'flex' }}>
                <ColorBox
