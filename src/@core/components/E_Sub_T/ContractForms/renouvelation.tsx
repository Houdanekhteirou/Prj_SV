...
import { repoEnum, schema_contract_action as schema } from 'src/constants'
...
export const Renouvelment = ({ id, contractTypes, allBanks, contract, operation }) => {
